...
namespace t5f25sdprojectone_projectsplus.Services.Interfaces
{
    public interface IInfraOrchestrator
    {
        ...
        /// </summary>
        Task<InfraPreflightReport> DryRunAsync(long projectId, CancellationToken ct = default);

        /// <summary>
        /// Execute an orchestration plan for the project. Returns execution ticket or result summary.
        /// </summary>
        Task<InfraExecutionResult> ExecuteAsync(long projectId, CancellationToken ct = default);
    }
