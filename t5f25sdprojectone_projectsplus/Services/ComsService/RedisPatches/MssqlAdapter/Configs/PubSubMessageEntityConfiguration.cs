// src/Infrastructure/Storage/Dynamo/PubSubMessageEntityConfiguration.cs
using System;
...
{
    /// <summary>
    /// Helper / configuration utilities for persisting PubSubMessageEntity (message) instances into the
    ...
    /// and small helpers for optimistic concurrency (version-like patterns via attempts/status) and TTL handling.
    /// </summary>
    public static class PubSubMessageEntityConfiguration
    {
        ...
        /// </summary>
        public const string TypeDiscriminator = PubSubMessageEntity.TypeDiscriminator;
        ...
        /// <summary>
        /// Build a PutItemRequest to insert or replace a PubSubMessageEntity.
        /// </summary>
        public static PutItemRequest BuildPutRequest(string tableName, PubSubMessageEntity entity)
        {
            if (string.IsNullOrWhiteSpace(tableName)) throw new ArgumentNullException(nameof(tableName));
        ...
        /// <summary>
        /// Build a PutItemRequest that enforces create-only or expected status/version semantics.
        ...
        /// </summary>
        public static PutItemRequest BuildPutIfAttemptsMatches(string tableName, PubSubMessageEntity entity, int? expectedAttempts)
        {
        ...
        /// <summary>
        /// Try to parse a PubSubMessageEntity from a DynamoDB item dictionary.
        /// Returns null if the item is not a message entity.
        /// </summary>
        public static PubSubMessageEntity? TryParse(IDictionary<string, AttributeValue>? item)
        {
            return PubSubMessageEntity.FromItem(item);
        }
